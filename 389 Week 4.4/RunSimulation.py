...
Atmosphere(0.00015,NumberofParticles)
...
# Currently your interaction length is running over all axis directions and setting only that direction equal to to remain constant in its values - you need to set the entire array for position velocity and acceleration to remain const as of decay.